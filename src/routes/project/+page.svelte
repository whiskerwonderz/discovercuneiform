...
<div class="max-w-3xl mx-auto px-4 py-8 sm:py-12">
	<header class="mb-8 sm:mb-12 text-center">
		<div class="cuneiform text-3xl sm:text-4xl text-clay-400 mb-3 sm:mb-4">𒀭</div>
		<h1 class="font-display text-3xl sm:text-4xl font-medium text-clay-900 mb-3 sm:mb-4">
			About Discover Cuneiform
		</h1>
	...
	<section class="mb-8 sm:mb-10">
		...
		<div class="bg-clay-100 rounded-xl border border-clay-200 p-4 sm:p-6">
	...
	<section class="mb-8 sm:mb-10">
		...
		<div class="bg-clay-100 rounded-xl border border-clay-200 p-4 sm:p-5">
			<ul class="space-y-2 text-sm sm:text-base text-clay-700">
				<li>
					<strong>Sign data</strong> from <a href="https://oracc.museum.upenn.edu/osl/" target="_blank" rel="noopener noreferrer" class="text-lapis-600 hover:underline">ORACC Sign List</a>
					<span class="text-xs text-clay-500">(CC0 Public Domain)</span>
				</li>
				<li>
					<strong>Tablet texts</strong> from <a href="https://cdli.mpiwg-berlin.mpg.de/" target="_blank" rel="noopener noreferrer" class="text-lapis-600 hover:underline">CDLI</a>
					<span class="text-xs text-clay-500">(Non-commercial use)</span>
				</li>
				<li>
					<strong>Research links</strong> to <a href="https://www.ebl.lmu.de/" target="_blank" rel="noopener noreferrer" class="text-lapis-600 hover:underline">eBL</a>
					<span class="text-xs text-clay-500">(External reference)</span>
				</li>
			</ul>
	...
	<!-- Footer links -->
	<footer class="pt-6 sm:pt-8 border-t border-clay-200 flex flex-wrap justify-center gap-4 sm:gap-6 text-xs sm:text-sm">
		<a href="/" class="text-lapis-500 hover:text-lapis-600 hover:underline">Home</a>
		<a href="/discover" class="text-lapis-500 hover:text-lapis-600 hover:underline">Discover More</a>
		<a href="/resources" class="text-lapis-500 hover:text-lapis-600 hover:underline">Resources & Attribution</a>
	</footer>
</div>
